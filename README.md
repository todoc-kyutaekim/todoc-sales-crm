...
- **Last Updated**: 2026-09-03 (인공와우 통계를 2010~2025년 16개년으로 확대 · 1,424행 적재, 인사이트 연도 하드코딩 제거, 근거 미확인 2025년 정책 문구 삭제, HIRA 원본 데이터 출처 링크 추가, 외부기 방향(좌/우) 입력 제거, 보정 경유지가 있을 때 업체명·지역 어긋남 수정)
